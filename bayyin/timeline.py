...
# مقادير مواءَمة لإيقاع نظام المحاكم التجارية ولائحته: المصالحة ≤30 يوماً قبل القيد،
# التبليغ في اليوم التالي للقيد، الجلسة الأولى ≤20 يوماً ومذكرة الدفاع قبلها بيوم.
DURATIONS: dict[str, int] = {
    "mediation": 15,
    "router": 0, "intake_register": 0, "rejected": 0, "referred": 0, "research": 0,
    "notify_defendant": 1, "defendant_plea": 18, "plaintiff_plea": 7,
    "incidents": 1, "incident_ruling": 7,
    "hearing_manager": 3, "expert": 30, "close_pleadings": 7,
    "judgment": 20, "serve_judgment": 7,
