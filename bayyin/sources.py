...
_SEED: list[Article] = [
    ...
    _a("نظام المرافعات الشرعية", "الاستئناف", "اختصاص محكمة الاستئناف بمراجعة الحكم",
       "تنظر محكمة الاستئناف الحكم المستأنف بناءً على أسباب الاعتراض، فتؤيّده أو تلغيه أو تعدّله بحسب ما يظهر لها.",
       False, "مبدأ مراجعة الاستئناف؛ يُثبَّت رقم المادة ونصّها من النظام ولائحته."),
